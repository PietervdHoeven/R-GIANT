...
def get_transforms(
    ...
    means[fl_cols] = fl_means
    stds[fl_cols] = fl_stds
    ...
    means[diff_cols] = diff_means
    stds[diff_cols] = diff_stds
    ...
    means[count_cols] = count_means
    stds[count_cols] = count_stds
    ...
    norm_count_means, norm_count_stds, norm_count_qs_low, norm_counts_qs_high = compute_edge_stats(
        log_count_dataset, cols=rel_count_cols
        )
    means[rel_count_cols] = norm_count_means
    stds[rel_count_cols] = norm_count_stds
    # qs_low[rel_count_cols] = norm_count_qs_low
    # qs_high[rel_count_cols] = norm_counts_qs_high
